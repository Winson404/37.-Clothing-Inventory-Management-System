            ...
            <div class="card-body">
              <div class="container"id="printElement">
                <div class="row invoice-info d-flex p-0 m-0" style="line-height: 18px;">
                  ...
                  <div class="col-12">
                    <p class="text-center text-bold">CEBU & CO. <br> REQUISITION HISTORY</p>
                  ...
                  <table id="" class="table table-bordered table-hover text-xs mt-2 table-sm">
                    ...
                    <tbody id="users_data">
                      <?php
                      $sql = mysqli_query($conn, "SELECT * FROM requisition r JOIN products p ON r.prod_ID=p.prod_ID JOIN users s ON r.emp_ID=s.user_Id JOIN suppliers sup ON p.supplier_ID=sup.supplier_ID WHERE r.status=1 ORDER BY r.request_date");
