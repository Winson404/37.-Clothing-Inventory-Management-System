<title>Cebu & Co. | Employee records</title>
<?php
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header p-2">
              <a href="users_mgmt.php?page=create" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> New Employee</a>
